#!/usr/bin/env bash
# Kill any Termtastic server listening on the prod port (8082).
# The dev server runs on 8083 (see server/build.gradle.kts) and is left alone.
set -euo pipefail

PORT="${TERMTASTIC_PROD_PORT:-8082}"
